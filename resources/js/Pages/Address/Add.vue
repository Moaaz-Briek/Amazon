        ...
        <div class="w-[500px] mx-auto text-2xl font-extrabold">
            ...
            <form @submit.prevent="submit">
                ...
                <div class="mt-3">
                    ...
                    <TextInput v-model="form.addr1" type="text" class="mt-1 block w-full" required placeholder="Address Line 1"/>
                    <TextInput v-model="form.addr2" type="text" class="mt-1 block w-full" required placeholder="Address Line 2"/>
                </div>
                <div class="mt-3">
                    <div class="flex gap-2">
                        <div class="w-full">
                            <InputLabel class="-mb-1.5" value="City"/>
                            <TextInput v-model="form.city" type="text" class="mt-1 block w-full" required placeholder="City"/>
                        </div>
                        <div class="w-full">
                            <InputLabel class="-mb-1.5" value="PostCode"/>
                            <TextInput v-model="form.postcode" type="text" class="mt-1 block w-full" required placeholder="PostCode"/>
                        </div>
                    </div>
                </div>
                <div class="mt-6">
