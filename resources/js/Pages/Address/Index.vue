    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-[1000px] mx-auto flex gap-2 h-[270px]">
            ...
            <div class="relative border border-gray-400 rounded-md w-1/3 shadow-md">
                <div class="flex items-center justify-start p-3 text-sm text-gray-600 font-extrabold border-b border-b-gray-400">
                ...
                <div class="px-4 absolute bottom-0 pb-4">
                    <Link href="/" class="text-teal-700 text-sm font-extrabold hover:underline hover:text-red-700">
                        Remove
                    </Link>
                </div>
            </div>
