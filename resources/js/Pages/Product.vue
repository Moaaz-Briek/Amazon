    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-[1200px] mx-auto flex gap-4 justify-between">
            ...
            <div class="w-2/5">
                ...
                <div class="text-xl font-extrabold m-1">
            ...
            <div class="w-1/5">
                <div class="border border-gray-300 rounded-lg">
                    <div class="my-2 mx-3 mb-2">
                        <div class="flex items-center justify-center border-b border-b-gray-300 pb-1">
                            <Link v-if="$page.props.auth.user"
                                :href="route('address.index')"
                                class="flex items-center text-sm font-extrabold text-teal-700 hover:text-red-600 cursor-pointer"
                            >
