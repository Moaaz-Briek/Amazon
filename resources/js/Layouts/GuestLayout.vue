...
<template>
    <div class="min-h-screen flex flex-col items-center pt-6 bg-gray-100">
        ...
        <div class="w-full max-w-[400px] mt-6 px-6 py-4 border border-gray-300 bg-white overflow-hidden rounded-sm">
            <slot />
        </div>

        <div v-if="$page.url === '/login'" class="w-[400px]">
            <div class="text-center text-sm text-gray-500 font-bold py-4">
                New to Amazon
            </div>
